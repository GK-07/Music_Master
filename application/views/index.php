...
<html lang="en">
<head>
    <title>Miraculous - Online Music Store</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="ms_main_wrapper">
        ...
        <div class="ms_content_wrapper padder_top80">
            ...
            <!---Banner--->
            <img src="<?= base_url("resources/image")?>Wallpapers-eminem-performance-audience-hands.jpg" alt="">
           <div class="ms-banner">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="ms_banner_img">
                                <img src="<?= base_url("resources/user/")?>images/banner.png" alt="" class="img-fluid">
                            </div>
                                ...
                                <div class="weekly_left">
                                    ...
                                    <div class="w_top_song">
                                        <div class="w_tp_song_img">
                                            <img src="<?= base_url("resources/user/")?>images/weekly/<?= $key->image?>" alt="" class="img-fluid">
                                        ...
                                        <div class="w_tp_song_name">
                                            <h3><a href="<?=site_url("AlbumC/songsMoreInfo/$key->songid")?>"><?= $key->title?></a></h3>
                                            <p></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 padding_right40">
                            <?php
                                ...
                                {
                            ?>
                             <a href="<?= site_url('/AlbumC/album_more_info/'.$key->albumid)?>">
                            <div class="ms_weekly_box">
                                <div class="weekly_left">
                                    <span class="w_top_no">
                                        <?= $i++?>
                                    ...
                                    <div class="w_top_song">
                                         <div class="w_tp_song_img">
                                            <img src="<?= base_url("resources/")?>image/<?= $key->cover?>" alt="" class="img-fluid">
                                            <!-- <div class="ms_song_overlay">
                                            </div> -->
                                           <!--  <div class="ms_play_icon">
                                                <img src="<?= base_url("resources/user/")?>images/svg/play.svg" alt="">
                                        ...
                                        <div class="w_tp_song_name">
                                            <h3><a href="<?=site_url("AlbumC/album_more_info/$key->albumid")?>"><?= $key->name?></a></h3>
                                            <p><?= $key->description?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="weekly_right">
                                    <span class="w_song_time"><?= $key->releasedt?></span>
                                    <span class="ms_more_icon" data-other="1">
                                        <img src="<?= base_url("resources/user/")?>images/svg/more.svg" alt="">                                 
                                    </span> --> -->
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 padding_right40">
                            <?php
                                ...
                                {
                            ?>
                             <a href="<?= site_url('AlbumC/artist_more_info/'.$key->artistid)?>">                     
                            <div class="ms_weekly_box">
                                <div class="weekly_left">
                                    <span class="w_top_no">
                                        <?= $i++?>
                                    ...
                                    <div class="w_top_song">
                                        <div class="w_tp_song_img">
                                            <img src="<?= base_url("resources/")?>image/<?= $key->photo?>" alt="" class="img-fluid">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <!-- <div class="ms_play_icon">
                                                <img src="<?= base_url("resources/user/")?>images/svg/play.svg" alt="">
                                        ...
                                        <div class="w_tp_song_name">
                                            <h3><a href="<?=site_url("AlbumC/artist_more_info/$key->artistid")?>"><?= $key->name?></a></h3>
                                            <p><?= $key->description?></p>
                                        </div>
                                    </div>
                                </div>
