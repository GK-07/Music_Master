	...
	<body>
		...
		<div class="pcoded-inner-content">
			...
			<center>
				...
				<h5 class="sub-title">Add Admin</h5>
				<form method="post" enctype="multipart/form-data" action="<?= site_url("Musicadmin_c/Displayadm_c/addadmin");?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
 					<input type="text" class="form-control" name="txtuname" placeholder="Name input">	
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
 					<input type="E-mail" class="form-control" name="txtemail" placeholder="E-mail input">	
					</div>
				</div>
				<div class="form-group row">
