	...
	<body>
		...
		<div class="pcoded-inner-content">
			...
			<center>
				...
				<h5 class="sub-title">Add Album</h5>
				<form method="post" enctype="multipart/form-data" action="<?= site_url("Musicadmin_c/Displayalbum_c/addalbum");?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
 					<input type="text" class="form-control" name="txttype" placeholder="Name input">	
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Release date</label>
					<div class="col-sm-10">
 					<input type="text" class="form-control" name="txtreleasedt">	
					</div>
				</div>
				<div class="form-group row">
					<div class="col-sm-10">
 					<input type="hidden" value="0" class="form-control" name="txtstatus" placeholder="E-mail input">	
					</div>
				</div>
				<div class="form-group row">
