        ...
        <div class="ms_content_wrapper padder_top80">
           ...
           <div class="ms_header">
                <div class="ms_top_left">
                    <form action="<?= site_url("songs/search")?>" method="post">
                    <div class="ms_top_search">
                        <input name="search" type="text" class="form-control" placeholder="Search Music Here..">
                        <span class="search_icon">
                            <button class="btn btn-primary" style="background-color: none" type="submit"><img src="<?= base_url("resources/user/")?>/images/svg/search.svg" alt=""></button>
                        </span>
                    </div>
                </form>
